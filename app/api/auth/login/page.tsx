  ...
  return (
    <main className="mx-auto max-w-md px-6 py-16">
      ...
      <form onSubmit={submit} className="mt-8 space-y-4">
        ...
        <input name="customerID" placeholder="CleanCloud CustomerID" required className="w-full rounded-lg border px-4 py-2" value={form.customerID} onChange={onChange} />
      ...
      <p className="mt-4 text-center text-sm">
        New here? <a href="/auth/signup" className="text-blue-600 underline">Create an account</a>
      </p>
    </main>
  );
}
